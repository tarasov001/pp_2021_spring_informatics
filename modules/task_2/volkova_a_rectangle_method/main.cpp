...
TEST(Integral, Test2_100) {
    ...
    double parallel_integral = ParallelIntegralFunction(function1, -1, 1.9, -1.3, 2, 2, 6.5, 10, 10, 100);
...
TEST(Integral, Test3_1000) {
    ...
    double parallel_integral = ParallelIntegralFunction(function3, 0, 1.8, -1.2, 1.1, -1, 2.9, 10, 1000, 1000);
...
TEST(Integral, Test4_1000) {
    ...
    double parallel_integral = ParallelIntegralFunction(function3, 0.5, 1.7, -1, 2, -4, 1.9, 1000, 10, 1000);
...
TEST(Integral, Test5_100000) {
    ...
    double parallel_integral = ParallelIntegralFunction(function1, 0.1, 1, -1, 2, 4.2, 6, 10, 10, 100000);
...
TEST(Integral, Test6_90) {
    ...
    double parallel_integral = ParallelIntegralFunction(function1, 0.1, 1, -1.1, 2, -1, 5, 90, 90, 90);
    double value = 8.2863;
    ASSERT_LE(std::abs(parallel_integral - value), 1e-3);
    std::cout << "value: " << value << std::endl;
    std::cout << "integral: " << integral << std::endl;
