...
TEST(test_tkachev_a_graham_pass, test_5_size_3_any) {
    std::vector<Point> const points = {
...
TEST(test_tkachev_a_graham_pass, test_6_size_2_any) {
    std::vector<Point> const points = {
        {10.15, 5.0}, {0.0, 5.2}
    };
    std::stack<Point> graham = useGrahamAlgorithm(points);
...
TEST(test_tkachev_a_graham_pass, test_7_size_1_any) {
    std::vector<Point> const points = {
        {1, 1}
    };
    std::stack<Point> graham = useGrahamAlgorithm(points);
    ...
    std::vector<double> true_solution_x = {1};
    std::vector<double> true_solution_y = {1};
    ASSERT_EQ(graham_x, true_solution_x);
    ASSERT_EQ(graham_y, true_solution_y);
}
